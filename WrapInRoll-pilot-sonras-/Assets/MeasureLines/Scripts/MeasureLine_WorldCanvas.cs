...
//	}
	...
	//Delete line between two object
...
//			Debug.Log("DelSurfaceLinks");
	...
	static public void DelSurfaceLinks(GameObject obj0, GameObject obj1)
	{
		string id_0_1 = obj0.GetInstanceID().ToString() + "_" + obj1.GetInstanceID().ToString();
		string id_1_0 = obj1.GetInstanceID().ToString() + "_" + obj0.GetInstanceID().ToString();
	...
	static public void DrawLine(Transform newTarget, bool InitSizeForVR, bool canBeBlock, bool onSurface)
	{
		...
		if (staticTarget==null || (!onSurface && staticTarget!=newTarget) || (onSurface && staticTarget.parent != newTarget.parent) )
		{
			...
			{
				AddLine(staticTarget, newTarget, InitSizeForVR, canBeBlock, onSurface);
			}
